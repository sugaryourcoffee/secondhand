...
describe "Acceptances index page" do
  ...
  context "with active event" do
    ...
    it "should show warning when searching for a not registered list" do
      ...
      page.should have_text "List #{unregistered_list.list_number} is not registered."
    end
    ...
    it "should revoke acceptance of an accepted list when clicking on 'Revoke Acceptance'" do
      click_link "Accepted"
