...
describe Event do
  ...
  it "requires a title" do
    ...
    event.errors[:title].any?.should be_true
  end
  ...
  it "requires an event_date" do
    ...
    event.should_not be_valid
    event.errors[:event_date].any?.should be_true
  end
  ...
  it "requires a location" do
    ...
    event.should_not be_valid
    event.errors[:location].any?.should be_true
  end
  ...
  it "requires a fee" do
    ...
    event.should_not be_valid
    event.errors[:fee].any?.should be_true
  end
  ...
  it "requires a deduction" do
    ...
    event.should_not be_valid
    event.errors[:deduction].any?.should be_true
  end
  ...
  it "requires a provision" do
    ...
    event.should_not be_valid
    event.errors[:provision].any?.should be_true
  end
  ...
  it "requires max_lists" do
    ...
    event.should_not be_valid
    event.errors[:max_lists].any?.should be_true
  end
  ...
  it "requires max_items_per_list" do
    ...
    event.should_not be_valid
    event.errors[:max_items_per_list].any?.should be_true
  end
end
